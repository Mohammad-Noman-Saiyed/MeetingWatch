              ...
              <div className="flex items-center gap-3 flex-wrap">
                ...
                >
                  ...
                  <select
                    value={xMetric}
                    onChange={(e) =>
                      setXMetric(e.target.value as ComparisonMetric)
                    }
                    className="rounded-lg px-3 py-2 text-sm bg-transparent border cursor-pointer"
                    style={{
                      borderColor: "rgba(62,207,142,0.4)",
                ...
                >
                  ...
                  <select
                    value={yMetric}
                    onChange={(e) =>
                      setYMetric(e.target.value as ComparisonMetric)
                    }
                    className="rounded-lg px-3 py-2 text-sm bg-transparent border cursor-pointer"
                    style={{
                      borderColor: "rgba(62,207,142,0.4)",
              ...
              <>
                ...
                <div className="flex items-center gap-4 mb-10">
                  <button
                    ...
                    className="px-4 py-2 rounded-lg cursor-pointer text-sm font-semibold text-black disabled:opacity-50 disabled:cursor-not-allowed"
                    style={{
                      background:
